       ...
       @csrf 
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="batchno" class="form-control" id="exampleFormControlInput1" placeholder="Batch no.">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Quantity</label>
                <input type="text" name="quantity" class="form-control" id="exampleFormControlInput1" placeholder="Quantity">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="remark" id="exampleFormControlTextarea1" rows="3"></textarea>
            </div>
